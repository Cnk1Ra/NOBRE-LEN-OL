...
function SettingsContent() {
  ...
  const handleAvatarChange = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      reader.onerror = () => { throw new Error('Erro ao ler arquivo') }
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue={initialTab} className="space-y-6">
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">JPG, PNG, GIF, WEBP. Max 2MB</p>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Input id="phone" type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="(00) 00000-0000" className="flex-1" />
                  </div>
                </div>
              </div>
              <div className="flex items-center justify-between pt-4">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  {hasChanges ? (
                    ...
                    <><Check className="h-4 w-4 text-green-600" /><span>Tudo salvo</span></>
                  )}
                </div>
        ...
        <TabsContent value="company" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Informações da sua empresa para documentos e relatórios</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="companyCnpj" value={companyCnpj} onChange={(e) => setCompanyCnpj(e.target.value)} placeholder="00.000.000/0000-00" />
                </div>
                <div className="space-y-2 md:col-span-2">
                  <Label htmlFor="companyAddress">Endereço</Label>
                  <Input id="companyAddress" value={companyAddress} onChange={(e) => setCompanyAddress(e.target.value)} placeholder="Rua, número, complemento" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="companyCity">Cidade</Label>
                  <Input id="companyCity" value={companyCity} onChange={(e) => setCompanyCity(e.target.value)} placeholder="Cidade" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="companyState">Estado</Label>
                  <Input id="companyState" value={companyState} onChange={(e) => setCompanyState(e.target.value)} placeholder="Estado" />
                </div>
                <div className="space-y-2">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Seja notificado quando um novo pedido for recebido</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Receba atualizações sobre status de entregas</p>
                </div>
        ...
        <TabsContent value="integrations" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><Link2 className="h-5 w-5" />Integrações</CardTitle>
              <CardDescription>Conecte suas plataformas de e-commerce e marketing</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">Em breve você poderá conectar Shopify, WooCommerce, Facebook Ads e mais.</p>
            </CardContent>
          </Card>
        </TabsContent>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">Gerencie os dispositivos conectados à sua conta.</p>
